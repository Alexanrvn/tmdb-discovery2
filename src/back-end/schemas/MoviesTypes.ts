...
// TypeScript type for the raw movie object from the TMDB API.
...
// TypeScript type for the supported movie format used in our application, omitting 'adult' and 'video' properties.
export type Movie = Omit<TmdbMovie, 'adult' | 'video'>;

// TypeScript type for the API error response.
